...
function clearCharactersAndFinisgGame(){
...
function finishGame(){
    if(findCharmander && findPikachu && findZubat){clearCharactersAndFinisgGame();
...
function verifyLookPokemon(to) {
    ...
    if ((getTopPosition() >= 474 && getTopPosition() <= 594) && (getRightPosition() <= 98 && getRightPosition() >= 90)) {
